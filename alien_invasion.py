...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Also initializing pygame audio system,i.e. pygame.mixer.init()
        pygame.init()
    ...
    def _exit_game(self):
        """Write the high score and quit the program."""
    ...
    def _check_bullet_alien_collisions(self):
        ...
        if collisions:
            for aliens in collisions.values():
                ...
                self.stats.high_score += self.settings.alien_points * len(aliens)
            self.sb.prep_score()
            self.sb.check_high_score()
        if not self.aliens:
            # Destroy existing bullets, create new fleet, and increase game's tempo.
            self.bullets.empty()
            self._create_fleet()
